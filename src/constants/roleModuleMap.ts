...
export const roleModuleMap: Record<RoleName, string[]> = {
  ...
  "Department Head": withProfile(["department-dashboard", "leave-workflow", "my-announcements", "announcements-training", "my-attendance", "my-performance", "my-benefits", "my-payslips", "my-documents", "complaints", "leave-approvals", "reports-analytics", "ai-assistant"]),
  Finance: withProfile(["finance-dashboard", "payroll", "payroll-history", "tax-compliance", "compensation-data", "finance-grievances", "my-attendance", "my-benefits", "my-payslips", "my-documents", "my-announcements", "announcements-training", "complaints", "ai-assistant"]),
  Employee: withProfile(["employee-dashboard", "leave-workflow", "my-announcements", "my-attendance", "my-performance", "my-benefits", "my-payslips", "my-documents", "announcements-training", "complaints", "ai-assistant"]),
};
